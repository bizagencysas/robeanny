...
const pageMeta: Record<Locale, { title: string; description: string }> = {
  es: {
    ...
    description:
      "Portfolio completo de Robeanny Bastardo Liconte. Fotografía editorial, campañas comerciales y contenido de moda profesional en Colombia.",
  },
  en: {
    title: "Editorial Portfolio",
    description:
      "Complete portfolio of Robeanny Bastardo Liconte. Editorial photography, commercial campaigns, and professional fashion content in Colombia.",
  },
};
