...
const PAGE_PATH = "/journal";

const pageMeta: Record<Locale, { title: string; description: string }> = {
  es: {
    title: "Journal de Moda",
    description:
      "Articulos de moda, behind the scenes, consejos de modelaje y perspectiva editorial de Robeanny Bastardo.",
  },
  en: {
    title: "Fashion Journal",
    description:
      "Fashion articles, behind-the-scenes stories, modeling tips, and editorial perspective by Robeanny Bastardo.",
  },
};
